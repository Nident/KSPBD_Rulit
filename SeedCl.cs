        ...
        public static void Seed(Context context)
        {
            ...
            if (!context.Объект.Any())
            {
                context.Объект.AddRange(
                    ...
                    new Объект { Район = "Приокский", Улица = "Октябрьская 32к2", Статус = "Строится" },
                    new Объект { Район = "Приокский", Улица = "Октябрьская 33к2", Статус = "Строится" },
                    new Объект { Район = "Приокский", Улица = "Октябрьская 34к2", Статус = "Строится" },
